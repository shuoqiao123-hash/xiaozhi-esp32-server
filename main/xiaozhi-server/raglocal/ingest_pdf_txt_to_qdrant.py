...
def parse_args():
    parser = argparse.ArgumentParser(description="Import a PDF or TXT into local Qdrant knowledge collection")
    parser.add_argument("--file", required=True, help="Absolute path to PDF or TXT file")
...
def build_documents(file_path: str, doc_id: str, title: str):
...
def main():
    ...
    documents = build_documents(file_path, args.doc_id, args.title)
